                ...
                <Dialog.Panel className="relative flex flex-wrap gap-sidebar-gap [@media(display-mode:window-controls-overlay)]:mt-titlebar-area-height">
                  ...
                  >
                    ...
                    <Transition.Child
                      ...
                      className="relative max-sm:fixed max-sm:left-[calc(100vw-theme(spacing[sidebar]))] flex flex-col w-sidebar h-full py-sidebar-gap pb-safe-offset-sidebar-gap gap-sidebar-gap"
                    >
                      <SidebarNotes />
                    </Transition.Child>
                  </Transition.Root>
